...
<div align="center">
  <img src="https://files.catbox.moe/y47h3b.png" alt="Perry" width="400"/>
  <br/>
...
**Perry** est un bot WhatsApp puissant conçu pour gérer et automatiser les publications sur les chaînes WhatsApp. Il permet de planifier des messages, des images et des vidéos avec une interface conversationnelle simple et intuitive.
...
- 🤖 **Assistant IA intégré** : Perry, votre assistant intelligent pour vous guider
...
L'assistant IA Perry répond à toutes vos questions sur l'utilisation du bot.
...
```bash
Perry comment configurer une chaîne ?
Perry comment programmer un post ?
Perry comment publier une image ?
```
...
[![License](https://img.shields.io/badge/License-MIT-1E90FF?style=for-the-badge)](LICENSE)
MIT © [Perry Digital 243](https://whatsapp.com/channel/0029VbBT7FdLCoX1TDyQQb1B)

---

<div align="center">
  <p><b>💻 Perry Digital 243</b> - <i>"Always Forward"</i></p>
